...
| AutoPilotMode   | 1        | 0 - Piloto automático do tipo Attitude ~ O usuário controla o ângulo.Quando os sticks Roll e Pitch do rádio são manipulados pelo piloto,o sistema de navegação inercial será ignorado,e os comando irão passar no formato By-Pass.Assim que os sticks Roll e Pitch do rádio estiverem centralizados,o sistema de navegação inercial irá retomar o piloto automático e manter a posição do multirotor. / 1 - Piloto automático do tipo Cruise ~ O sistema de navegação inercial estará sempre ativo e o usuário irá controlar a velocidade de navegação do Roll e Pitch,e o piloto automático irá calcular um novo controle de Attitude sozinho,assim mantendo a posição constantemente. |