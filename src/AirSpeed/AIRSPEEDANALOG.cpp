...
#define PITOT_ADC_VOLTAGE_SCALER 2.0f
...
{
  return (ANALOGSOURCE.Read_Voltage_Ratiometric(ADC_ANALOG_AIR_SPEED) * PITOT_ADC_VOLTAGE_SCALER - PITOT_ADC_VOLTAGE_ZERO) * PITOT_ADC_VOLTAGE_TO_PRESSURE;
}