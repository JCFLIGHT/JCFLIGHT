...
#define BEEP_ON
#define BEEP_OFF
#define RED_LED_PINOUT pinMode(GPIO_NUM_4, OUTPUT)
#define GREEN_LED_PINOUT pinMode(GPIO_NUM_2, OUTPUT)
#define BLUE_LED_PINOUT pinMode(GPIO_NUM_15, OUTPUT)
#define RED_LED_PWM_REGISTER GPIO_NUM_4
#define GREEN_LED_PWM_REGISTER GPIO_NUM_2
#define BLUE_LED_PWM_REGISTER GPIO_NUM_15
#define RED_LED_ON AnalogWriteApplyDuty(RED_LED_PWM_REGISTER, 255)
#define RED_LED_OFF AnalogWriteApplyDuty(RED_LED_PWM_REGISTER, 0)
#define GREEN_LED_ON AnalogWriteApplyDuty(GREEN_LED_PWM_REGISTER, 255)
#define GREEN_LED_OFF AnalogWriteApplyDuty(GREEN_LED_PWM_REGISTER, 0)
#define BLUE_LED_ON AnalogWriteApplyDuty(BLUE_LED_PWM_REGISTER, 255)
#define BLUE_LED_OFF AnalogWriteApplyDuty(BLUE_LED_PWM_REGISTER, 0)
#endif
