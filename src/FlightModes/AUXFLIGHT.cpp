...
void AUXFLIGHTCLASS::FlightModesAuxSelect(void)
{
  ...
  //ALTITUDE-HOLD EM MULTIROTORES
  //AUTO-THROTTLE EM AIRPLANES
  ...
  //GPS-HOLD EM MULTIROTORES
  //CIRCULOS EM AIRPLANE
  ...
  //AUTO LAND EM MULTIROTORES
  //CRUZEIRO EM AIRPLANES
  ...
  //ATTACK EM MULTIROTORES
  //AUTO LANÇAMENTO EM AIRPLANES
  if (AttackControlAux)
  {
  ...
  else
  {
    ...
    if (!IS_FLIGHT_MODE_ACTIVE(WAYPOINT_MODE)) //NECESSARIO PARA O MODO TAKEOFF DO WAYPOINT
    {
      DISABLE_THIS_FLIGHT_MODE(LAUNCH_MODE);
    }
  }
  //AUTO-FLIP EM MULTIROTORES
  //CURVA CORDENADA EM AIRPLANES
