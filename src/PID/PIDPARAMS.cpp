...
void UpdateValuesOfPID()
{
    ...
    GET_SET[MAX_PITCH_LEVEL].MinMaxValueVector = STORAGEMANAGER.Read_8Bits(MAX_PITCH_LEVEL_ADDR);
    GET_SET[MAX_ROLL_LEVEL].MinMaxValueVector = STORAGEMANAGER.Read_8Bits(MAX_ROLL_LEVEL_ADDR);
